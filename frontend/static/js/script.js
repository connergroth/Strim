 ...
 */
/**
 * Fetch user's activities from Strava with improved error handling
 */
async function fetchActivities() {
    try {
        ...
        // Simplified fetch call with minimal headers to avoid CORS issues
        const response = await fetch(`${BACKEND_URL}/activities`, {
            method: "GET",
            credentials: "include"  // Ensures cookies are sent
            // No additional headers to avoid triggering preflight requests
        });
        ...
        // Add more detailed error message for CORS errors
